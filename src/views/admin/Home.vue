...
<div class="wrapper">
    <aside id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a href="#" class="sidebar-link" @click.prevent="loadContent('/admin/crawl')">
...
export default {
    ...
    data() {
        return {
            isExpanded: false, // Dùng để kiểm soát trạng thái mở rộng của sidebar
        };
    },
    methods: {
        toggleSidebar() {
        ...
        loadContent(url) {
            this.$nextTick(() => {
                ...
                if (mainFrame) {
                    ...
                    console.error("Element with id 'main-frame' not found.");
                }
            });
        }
...
.navbar {
    background-color: #dad8d8b0;
    box-shadow: 0 0 2rem 0 rgba(65, 66, 66, 0.1);
}
